...
function Hero() {
  return (
     <div className="container ">
      <div className="row text-center mx-5 p-5">
        <h1 className='fs-2'>
      ...
      <div className="row  mt-5 p-5   border-top">
        ...
        <div className="col-md-6 col-sm-12 p-5">
          ...
          <p>
          And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="">blog</a> or see what the media is  
